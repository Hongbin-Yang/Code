...
CASE
	WHEN scaled_bought < 0.2 THEN 1
	WHEN scaled_bought < 0.4 THEN 2 -- between 0.2 and 0.4
	WHEN scaled_bought < 0.6 THEN 3
	WHEN scaled_bought < 0.8 THEN 4
	WHEN scaled_bought <= 1 THEN 5
	ELSE NULL
END AS rating
...
CASE
	WHEN scaled_bought = 0 THEN 0 -- or NULL
	WHEN scaled_bought < 0.2 THEN 1
	WHEN scaled_bought < 0.4 THEN 2
	WHEN scaled_bought < 0.6 THEN 3
	WHEN scaled_bought < 0.8 THEN 4
	WHEN scaled_bought <= 1 THEN 5
	ELSE NULL
